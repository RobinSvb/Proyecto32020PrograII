<%-- 
    Document   : CambiarEstadoClientes
    Created on : 28/10/2020, 06:12:49 PM
    Author     : rvasquez
--%>
 ...
 <% 
        ...
        %>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="<%=cliente.getId() %>" id="myInput" placeholder="Ingrese el id del Cliente" name="myInput">
            </div>
           ...
           cliente = clienteDao.getClienteFromDB(codigo);
            %>
                ...
                <p>Si usted desea revisar el cambio, debe ir a <a href="ReporteClientes.jsp">Mostrar Listado de Clientes</a></p> 
                <p>El Dato Actualizado es <%=cliente.toString() %></p>
            </form>
               <% 
          }
                %>
